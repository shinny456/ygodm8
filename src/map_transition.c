...
extern u8 g2021D6C[]; //unused?

inline int sub_80524A4 (u16 arg0) {
  arg0 &= 0x700;
  return gMapData[gOverworld.map.id][gOverworld.map.state]->unk168[arg0 >> 8].unk4;
}

inline void sub_80524D8 (u16 arg0) {
  gOverworld.map.unk8 = sub_80524A4(arg0);
  gOverworld.map.unk6 = 4;
}

//unused
inline void sub_8052510 (void) {
...
void sub_8052318 (u16 arg0) {
  u8 temp, temp2;
  gOverworld.map.unk6 = (arg0 & 0x700) >> 8;
  temp = sub_80524A4(arg0);
