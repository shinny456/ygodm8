...
static void sub_802E314 (void) {
  u16* ptr;
  u8 i;
  ConvertU64ToDigitArray(gMoney, 0);
...
static void sub_802E404 (void) {
  u16* ptr;
  u8 i;
  ConvertU64ToDigitArray(gShopSelectedCard.buyPrice, 0);
...
static void sub_802E4F4 (void) {
  u16* ptr;
  u8 i;
  ConvertU64ToDigitArray(gShopSelectedCard.sellPrice, 0);
...
static void sub_802E72C (void) {
  ...
  if (DoesNotExceedMoneyLimit(temp) == 1)
    ...
    temp2 = 9999999999999;
  ConvertU64ToDigitArray(temp2, 0);
...
static void sub_802F1B4 (void) {
  ...
  if (gCardInfo.id != CARD_NONE) {
    ConvertU64ToDigitArray(gShopHoveredCard.unk0, 1);
