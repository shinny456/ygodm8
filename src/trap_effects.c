...
static bool8 ConditionHouseOfAdhesiveTape(void)
{
    ...
    {
        gStatMod.card = gTurnZonePtrs[gTrapEffectData.unk2][gTrapEffectData.unk3]->id;
        gStatMod.field = gDuel.field;
        gStatMod.stage = GetFinalStage(gTurnZonePtrs[gTrapEffectData.unk2][gTrapEffectData.unk3]);
...
{
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[0][gTrapEffectData.trapZoneId], 1);
    if (!IsGodCard(gTurnZonePtrs[gTrapEffectData.unk2][gTrapEffectData.unk3]->id))
    {
        ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[gTrapEffectData.unk2][gTrapEffectData.unk3], 0);
    ...
    {
        gTurnZonePtrs[gTrapEffectData.unk2][gTrapEffectData.unk3]->isFaceUp = TRUE;
        if (!gHideEffectText)
        {
...
{
    gTurnZonePtrs[2][gTrapEffectData.unk3]->isFaceUp = TRUE;
    gTurnZonePtrs[2][gTrapEffectData.unk3]->isLocked = TRUE;
...
{
    DecrementPermStage(gTurnZonePtrs[2][gTrapEffectData.unk3]);
    gTurnZonePtrs[2][gTrapEffectData.unk3]->isFaceUp = TRUE;
    gTurnZonePtrs[2][gTrapEffectData.unk3]->isLocked = TRUE;
...
unsigned IsTrapTriggered (void) {
  ...
  for (i = 0; i < MAX_ZONES_IN_ROW; i++)
  {
      ...
      if (CheckTrapActivationConditions(gTurnZonePtrs[0][i]->id) == 1)
          return TRUE;
  }
  return FALSE;
}
