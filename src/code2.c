...
static void sub_800E11C(void)
{
    ...
    CopyCard(gTurnZonePtrs[row3][col3], gTurnZonePtrs[row2][col2]);
    ClearZone(gTurnZonePtrs[row2][col2]);
    sub_80404F0(0);
...
static void sub_800E1C4(void)
{
    ...
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row3][col3], 0);
    CopyCard(gTurnZonePtrs[row3][col3], gTurnZonePtrs[row2][col2]);
    ClearZone(gTurnZonePtrs[row2][col2]);
    sub_80404F0(0);
    LockMonsterCardsInRow(4);
...
static void sub_800E294(void)
{
    ...
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row4][col4], 0);
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row3][col3], 0);
    CopyCard(gTurnZonePtrs[row3][col3], gTurnZonePtrs[row2][col2]);
    ClearZone(gTurnZonePtrs[row2][col2]);
    sub_80404F0(0);
...
static void sub_800E3B4(void)
{
    ...
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row5][col5], 0);
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row4][col4], 0);
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row3][col3], 0);
    CopyCard(gTurnZonePtrs[row3][col3], gTurnZonePtrs[row2][col2]);
    ClearZone(gTurnZonePtrs[row2][col2]);
...
static void sub_800E50C(void)
{
    ...
    gTurnZonePtrs[row2][col2]->isDefending = FALSE;
    gTurnZonePtrs[row2][col2]->isFaceUp = TRUE;
    gTurnZonePtrs[row2][col2]->isLocked = TRUE;
}
...
static void sub_800E63C(void)
{
    ...
    gTurnZonePtrs[row2][col2]->isFaceUp = TRUE;
    gTurnZonePtrs[row2][col2]->isLocked = TRUE;
    gTurnZonePtrs[row3][col3]->isFaceUp = TRUE;
...
static void sub_800E734(void)
{
    ...
    gTrapEffectData.id = gTurnZonePtrs[row2][col2]->id;
    IsTrapTriggered();
    ActivateTrapEffect();
}
...
static void sub_800E8B4(void)
{
    ...
    gTurnZonePtrs[row2][col2]->isFaceUp = TRUE;
    gTurnZonePtrs[row2][col2]->isLocked = TRUE;
    gMonEffect.id = gTurnZonePtrs[row2][col2]->id;
    gMonEffect.row = row2;
...
static void sub_800E92C(void)
{
    ...
    ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row2][col2], 0);
}
...
static void sub_800E958(void)
{
    ...
    gTurnZonePtrs[row2][col2]->isDefending = TRUE;
    gTurnZonePtrs[row2][col2]->isLocked = TRUE;
}
...
static void sub_800EB40(void)
{
    ...
    gSpellEffectData.id = gTurnZonePtrs[row2][col2]->id;
...
static void sub_800ED48(void)
{
    ...
    if (GetRitualNumTributes(gTurnZonePtrs[row2][col2]->id) == 2)
    {
        ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row4][col4], 0);
        ClearZoneAndSendMonToGraveyard(gTurnZonePtrs[row5][col5], 0);
    }
...
static void sub_800F298(void)
{
    u8 row2 = sAI_Command.unk2 >> 4;
    u8 col2 = foo2();
    u16 cardId = gTurnZonePtrs[row2][col2]->id;
    ...
    if (gCardInfo.spellEffect == 2)
    {
        ...
        {
        case 0:
            if (GetExodiaFlag(cardId) && NumCardMatchesInRow(&gTurnZonePtrs[row2][col2], cardId) < 2)
        ...
        gStatMod.card = gTurnZonePtrs[row2][col2]->id;
        gStatMod.field = gDuel.field;
        gStatMod.stage = GetFinalStage(gTurnZonePtrs[row2][col2]);
...
static void sub_800F640(void)
{
    ...
    SetCardInfo(gTurnZonePtrs[row2][col2]->id);
    if (gCardInfo.unk1E)
        gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) != 1)
        gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else if (sub_8045390(gTurnZonePtrs[row2][col2]->id) != 0)
        gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else if (GetExodiaFlag(gTurnZonePtrs[row2][col2]->id) && NumCardMatchesInRow(gTurnZonePtrs[row2], gTurnZonePtrs[row2][col2]->id) < 2)
        sub_800F830();
    else if (gTurnZonePtrs[row3][col3]->id == CARD_NONE)
        gUnk_8DFF6A4->unk2298 = 0x7F3D9A1C;
    else if (gTurnZonePtrs[row3][col3]->isLocked)
        gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else if (GetTypeGroup(gTurnZonePtrs[row3][col3]->id) != 1)
        gUnk_8DFF6A4->unk2298 = 0x7F3D9A1C;
    else
    {
        u16 atk;
        ...
        SetFinalStat(&gStatMod);
        atk = gCardInfo.atk;
        gStatMod.card = gTurnZonePtrs[row3][col3]->id;
        gStatMod.field = gDuel.field;
        gStatMod.stage = GetFinalStage(gTurnZonePtrs[row3][col3]);
        SetFinalStat(&gStatMod);
...
static void sub_800F830 (void) {
  ...
  u8 row3 = sAI_Command.unk3 >> 4;
  u8 col3 = sAI_Command.unk3 & 0xF;
  if (gTurnZonePtrs[row3][col3]->id == CARD_NONE)
...
static void sub_800F95C (void) {
  ...
  if (!gCardInfo.unk1E)
    ...
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (sub_8045390(gTurnZonePtrs[row2][col2]->id))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (gTurnZonePtrs[row3][col3]->id == CARD_NONE)
    gUnk_8DFF6A4->unk2298 = 0x7F3D9A1C;
  else if (gTurnZonePtrs[row3][col3]->isLocked)
...
static void sub_800FB00(void)
{
  ...
  if (gCardInfo.unk1E)
    ...
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (sub_8045390(gTurnZonePtrs[row2][col2]->id) != 1)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) != 1)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else {
    u16 atk;
    gStatMod.card = gTurnZonePtrs[row2][col2]->id;
...
static void sub_800FDC8 (void) {
  ...
  if (gCardInfo.unk1E)
    ...
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (sub_8045390(gTurnZonePtrs[row2][col2]->id) != 2)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) != 1)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row4][col4]) != 1)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else {
    u16 atk;
    gStatMod.card = gTurnZonePtrs[row2][col2]->id;
    ...
    if (atk <= gCardInfo.atk)
      ...
      gStatMod.card = gTurnZonePtrs[row4][col4]->id;
      gStatMod.field = gDuel.field;
      gStatMod.stage = GetFinalStage(gTurnZonePtrs[row4][col4]);
      SetFinalStat(&gStatMod);
      if (atk <= gCardInfo.atk)
        gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
      else
...
static void sub_8010198 (void) {
  ...
  if (gCardInfo.unk1E)
    ...
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (sub_8045390(gTurnZonePtrs[row2][col2]->id) != 3)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) != 1)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row4][col4]) != 1)
    ...
    if (atk <= gCardInfo.atk)
      ...
      if (atk <= gCardInfo.atk)
        ...
        gStatMod.card = gTurnZonePtrs[row5][col5]->id;
        gStatMod.field = gDuel.field;
        gStatMod.stage = GetFinalStage(gTurnZonePtrs[row5][col5]);
        SetFinalStat(&gStatMod);
        if (atk <= gCardInfo.atk)
          gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
        else
...
static void sub_8010A40 (void) {
  ...
  if (gCardInfo.unk1E)
    ...
    gUnk_8DFF6A4->unk229C = gTurnZonePtrs[row3][col3]->id;
  }
}
...
static void sub_8010B08 (void) {
  ...
  else if (gTurnZonePtrs[row3][col3]->id != CARD_NONE) { //_08010B94
    if (gUnk_8DFF6A4->unk229C == gTurnZonePtrs[row3][col3]->id)
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else {
      u32 temp;
      gStatMod.card = gTurnZonePtrs[row2][col2]->id;
  ...
  else if (gTurnZonePtrs[row2][col2]->id != CARD_NONE) { //_08010BE0
    u32 temp;
    gStatMod.card = gTurnZonePtrs[row2][col2]->id;
    gStatMod.field = gDuel.field;
    gStatMod.stage = GetFinalStage(gTurnZonePtrs[row2][col2]);
...
static void sub_8011528 (void) {
  ...
  u8 row3 = sAI_Command.unk3 >> 4;
  u8 col3 = sAI_Command.unk3 & 0xF;
  if (gTurnZonePtrs[row2][col2]->id != DESTINY_BOARD && !NumCardMatchesInRow(gTurnZonePtrs[3], DESTINY_BOARD))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (NumCardMatchesInRow(gTurnZonePtrs[3], gTurnZonePtrs[row2][col2]->id) > 0)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (gTurnZonePtrs[row3][col3]->id == CARD_NONE)
    gUnk_8DFF6A4->unk2298 = 0x7EEB5B43;
  else if (GetFINAL_Flag(gTurnZonePtrs[row3][col3]->id) > 0)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_80116F0 (void) {
  ...
  u8 col3 = sAI_Command.unk3 & 0xF;
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (!gCardInfo.unk1E && gTurnZonePtrs[row3][col3]->id == CARD_NONE)
...
static void sub_8011878 (void) {
  ...
  if (gCardInfo.unk1E)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  if (gTurnZonePtrs[row2][col2]->id == JAM_BREEDING_MACHINE) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  }
  if (gTurnZonePtrs[row2][col2]->id == MESSENGER_OF_PEACE) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  }
  gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
...
static void sub_8011A30 (void) {
  u8 row3 = sAI_Command.unk3 >> 4;
  u8 col3 = sAI_Command.unk3 & 0xF;
  if (gTurnZonePtrs[row3][col3]->id == HARPIE_LADY)
    gUnk_8DFF6A4->unk2298 = 0x7FF55169;
  else if (gTurnZonePtrs[row3][col3]->id == CYBER_HARPIE)
    gUnk_8DFF6A4->unk2298 = 0x7FF55169;
  else
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
}
...
static void sub_8011C04 (void) {
  ...
  gStatMod.card = gTurnZonePtrs[2][zones[1]]->id;
  gStatMod.field = gDuel.field;
  gStatMod.stage = GetFinalStage(gTurnZonePtrs[2][zones[1]]);
  SetFinalStat(&gStatMod);
  if (ritualAtk <= gCardInfo.atk)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else {
    u32 temp;
    gUnk_8DFF6A4->unk2298 = 0xFFFE - gCardInfo.atk;
    gStatMod.card = gTurnZonePtrs[2][zones[2]]->id;
    gStatMod.field = gDuel.field;
    gStatMod.stage = GetFinalStage(gTurnZonePtrs[2][zones[2]]);
    SetFinalStat(&gStatMod);
    if (ritualAtk < gCardInfo.atk)
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else {
...
static void sub_8011D80 (void) {
  ...
  u8 i;
  for (i = 0; i < 5; i++) {
    struct DuelCard* zone = gTurnZonePtrs[1][i];
...
static void sub_8011E44 (void) {
  ...
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  ritualEffect = gCardInfo.ritualEffect;
  if (gTurnZonePtrs[row4][col4]->id != gRitualComponents[ritualEffect][2]) {
    if (gTurnZonePtrs[row4][col4]->id != gRitualComponents[ritualEffect][3]) {
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
      return;
    }
    else if (gTurnZonePtrs[row5][col5]->id != gRitualComponents[ritualEffect][2]) {
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
      return;
    }
  }
  else if (gTurnZonePtrs[row5][col5]->id != gRitualComponents[ritualEffect][3]) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  }
  //_08011F4C
...
static void sub_80120E8 (void) {
  u8 row3 = sAI_Command.unk3 >> 4;
  u8 col3 = sAI_Command.unk3 & 0xF;
  if (gTurnZonePtrs[row3][col3]->id == ZOA)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
}
...
static void sub_8012240 (void) {
  ...
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  ritualEffect = gCardInfo.ritualEffect;
  if (gTurnZonePtrs[row3][col3]->id == gRitualComponents[ritualEffect][0])
    ritualEffect = 24;
  else
    ritualEffect = 26;
...
static void sub_801245C (void) {
  ...
  for (i = 0; i < 5; i++) {
    if (gTurnZonePtrs[2][i]->id == CARD_NONE)
      continue;
    if (!gTurnZonePtrs[2][i]->isFaceUp)
      continue;
    if (gTurnZonePtrs[2][i]->isLocked)
      continue;
...
static void sub_8012C2C (void) {
  if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[2]) != 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[1]) == 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8012CA0 (void) {
  if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[1]) == 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8013050 (void) {
  u8 i;
  for (i = 0; i < 5; i++)
    if (gTurnZonePtrs[1][i]->id != CARD_NONE && !gTurnZonePtrs[1][i]->isFaceUp) {
...
static void sub_8013820 (void) {
  u8 i;
  for (i = 0; i < 5; i++)
    if (gTurnHandPtrs[1][i]->id != CARD_NONE && !gTurnHandPtrs[1][i]->isFaceUp) {
...
static void sub_8013884 (void) {
  if (NumEmptyZonesInRow(gTurnZonePtrs[4]) < 2)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_80138CC (void) {
  u8 numNonEmptyZones = 5 - NumEmptyZonesInRow(gTurnHandPtrs[1]);
  if (!numNonEmptyZones)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
...
static void sub_80139F4 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], KURIBOH))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!NumEmptyZonesInRow(gTurnZonePtrs[2]))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8013D20 (void) {
  if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[2]) != 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[1]) == 5 && NumEmptyZonesInRow(gTurnZonePtrs[0]) == 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8016464 (void) {
  u32 numNonEmptyZones = 5 - NumEmptyZonesInRow(gTurnZonePtrs[1]);
  u32 numCards;
  u8 i;
  if (!numNonEmptyZones) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
...
static void sub_8016584 (void) {
  ...
  if (gDuel.field == FIELD_YAMI) {
    for (i = 0; i < 5; i++)
      if (gTurnZonePtrs[2][i]->id == CARD_NONE && gTurnZonePtrs[2][i]->isFaceUp)
        numCards++;
    if (!numCards) {
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
      return;
...
static void sub_8016604 (void) {
  ...
  u32 totalAtk;
  for (i = 0; i < 5; i++)
    if (gMonEffect.zone != i && gTurnZonePtrs[2][i]->id != CARD_NONE &&
      gTurnZonePtrs[2][i]->id != CATAPULT_TURTLE && !gTurnZonePtrs[2][i]->isLocked)
        numCards++;
  if (!numCards) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  ...
  totalAtk = 0;
  for (i = 0; i < 5; i++) {
    if (gTurnZonePtrs[2][i]->id == CARD_NONE || gTurnZonePtrs[2][i]->id == CATAPULT_TURTLE)
      continue;
...
static void sub_80169FC (void) {
  ...
  if (GetNumFaceUpCardsInRow(1)) {
    u8 zone = HighestAtkFaceUpMonInRow(gTurnZonePtrs[1]);
...
static void sub_8016AE0 (void) {
  ...
  highestAtkZone = HighestAtkMonInRowExceptGodCards(gTurnZonePtrs[1]);
  if (gTurnZonePtrs[1][highestAtkZone]->isFaceUp) {
    u8 row2, col2;
    gStatMod.card = gTurnZonePtrs[1][highestAtkZone]->id;
    gStatMod.field = gDuel.field;
    gStatMod.stage = GetFinalStage(gTurnZonePtrs[1][highestAtkZone]);
    SetFinalStat(&gStatMod);
    atk = gCardInfo.atk;
    row2 = sAI_Command.unk2 >> 4;
    col2 = sAI_Command.unk2 & 0xF;
...
static void sub_8016BCC (void) {
  ...
  u8 row2, col2;
  u16 atk;
  if (!sub_8043584(gTurnZonePtrs[4], TYPE_INSECT)) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  }
  insectMonZone = HighestAtkMonOfTypeInRow(gTurnZonePtrs[4], TYPE_INSECT);
  gStatMod.card = gTurnZonePtrs[4][insectMonZone]->id;
  gStatMod.field = gDuel.field;
  gStatMod.stage = GetFinalStage(gTurnZonePtrs[4][insectMonZone]);
  SetFinalStat(&gStatMod);
  atk = gCardInfo.atk;
  row2 = sAI_Command.unk2 >> 4;
  col2 = sAI_Command.unk2 & 0xF;
...
static void sub_8016D7C (void) {
  u8 i, col2;
  u32 numCards;
  if (!NumEmptyZonesInRow(gTurnHandPtrs[1])) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  }
  numCards = 0;
  for (i = 0; i < 5; i++)
    if (gTurnZonePtrs[1][i]->id != CARD_NONE && !IsCardFaceUp(gTurnZonePtrs[1][i]))
      numCards++;
  for (i = 0; i < 5; i++)
    if (gTurnZonePtrs[0][i]->id != CARD_NONE && !IsCardFaceUp(gTurnZonePtrs[0][i]))
      numCards++;
  if (!numCards) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
  ...
  numCards = 0;
  for (i = 0; i < 5; i++)
    if (i != col2 && gTurnZonePtrs[2][i]->id != CARD_NONE && !IsCardFaceUp(gTurnZonePtrs[2][i]))
      numCards++;
  if (numCards) {
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    return;
...
static void sub_801729C (void) {
  asm_unified("push {r4, r5, r6, r7, lr}\n\
	...
	b _080174BA\n\
	.align 2, 0\n\
_080172C0: .4byte gTurnZonePtrs+0x14\n\
...
static void sub_80174D8 (void) {
  ...
  temp -= NumEmptyZonesInRow(gTurnZonePtrs[0]) - 5;
  if (!temp)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_80176E0 (void) {
  if (!NumEmptyZonesInRow(gTurnZonePtrs[4]))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8017728 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], HARPIES_PET_DRAGON))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
    gUnk_8DFF6A4->unk2298 = GetTotalAtkAndDefInRow(2);
}
...
static void sub_8017848 (void) {
  if (NumCardMatchesInRow(gTurnZonePtrs[2], BABY_DRAGON) > 0)
    gUnk_8DFF6A4->unk2298 = 0x7EF2D567;
  else if (NumCardMatchesInRow(gTurnZonePtrs[2], DARK_MAGICIAN) > 0)
    gUnk_8DFF6A4->unk2298 = 0x7EF2D567;
  else
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
}
...
static void sub_8017B34 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], DUNGEON_WORM))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
    gUnk_8DFF6A4->unk2298 = GetTotalAtkAndDefInRow(2);
}
...
static void sub_8017BC4 (void) {
  u8 numArmoredZombie = NumCardMatchesInRow(gTurnZonePtrs[2], ARMORED_ZOMBIE);
  u8 numDragonZombie = NumCardMatchesInRow(gTurnZonePtrs[2], DRAGON_ZOMBIE);
  u8 numClownZombie = NumCardMatchesInRow(gTurnZonePtrs[2], CLOWN_ZOMBIE);
...
static void sub_8017CC8 (void) {
  ...
  numNonEmptyZones = 5 - NumEmptyZonesInRow(gTurnZonePtrs[1]);
  numNonEmptyZones2 = 5 - NumEmptyZonesInRow(gTurnZonePtrs[2]);
...
static void sub_8017E74 (void) {
  if (!NumEmptyZonesInRow(gTurnZonePtrs[0]))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018034 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], M_WARRIOR_2))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018080 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], M_WARRIOR_1))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018308 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], LAVA_BATTLEGUARD))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018358 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], SWAMP_BATTLEGUARD))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018430 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], LABYRINTH_WALL))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
    gUnk_8DFF6A4->unk2298 = 0x7EF2D56D;
}
...
static void sub_8018540 (void) {
  if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[2]) < 4)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (NumEmptyZonesAndGodCardsInRow(gTurnZonePtrs[1]) == 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018AA4 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], BETA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!NumCardMatchesInRow(gTurnZonePtrs[2], GAMMA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018B20 (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], ALPHA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!NumCardMatchesInRow(gTurnZonePtrs[2], GAMMA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018B9C (void) {
  if (!NumCardMatchesInRow(gTurnZonePtrs[2], ALPHA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!NumCardMatchesInRow(gTurnZonePtrs[2], BETA_THE_MAGNET_WARRIOR))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
    gUnk_8DFF6A4->unk2298 = 0x7F12E09B;
}
...
static void sub_8018C18 (void) {
  ...
  if (NumEmptyZonesInRow(gTurnZonePtrs[2], 1) < 2)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_8018C18 (void) {
  asm_unified("push {lr}\n\
	ldr r0, _08018C34 @ =gTurnZonePtrs+0x28\n\
	movs r1, #0\n\
	bl NumEmptyZonesInRow\n\
	cmp r0, #1\n\
	bgt _08018C44\n\
	...
	b _08018C4E\n\
	.align 2, 0\n\
_08018C34: .4byte gTurnZonePtrs+0x28\n\
...
static void sub_8019078 (void) {
  if (!sub_8043584(gTurnZonePtrs[2], TYPE_DRAGON))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_80191B8 (void) {
  if (NumEmptyZonesInRow(gTurnZonePtrs[4]) == 5)
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!sub_8043584(gTurnZonePtrs[0], 0x15))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_801926C (void) {
  if (!NumEmptyZonesInRow(gTurnZonePtrs[2]))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else if (!NumCardMatchesInRow(gTurnZonePtrs[2], QUEENS_KNIGHT))
    gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
  else
...
static void sub_80192E4 (void) {
  u8 numYDragonHeads = NumCardMatchesInRow(gTurnZonePtrs[2], Y_DRAGON_HEAD);
  u8 numZMetalTanks = NumCardMatchesInRow(gTurnZonePtrs[2], Z_METAL_TANK);
  if (!numYDragonHeads) {
    if (!numZMetalTanks)
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
    else
...
static void sub_8019370 (void) {
  u8 numXHeadCannons = NumCardMatchesInRow(gTurnZonePtrs[2], X_HEAD_CANNON);
  u8 numZMetalTanks = NumCardMatchesInRow(gTurnZonePtrs[2], Z_METAL_TANK);
  if (!numXHeadCannons) {
    if (!numZMetalTanks)
      gUnk_8DFF6A4->unk2298 = 0x7EDE89F9;
...
u32 sub_80199B8 (void) {
  ...
  for (i = 0; i < 5; i++) {
    ...
    u16 opponentMonAtk;
    u8 j;
    struct DuelCard* playerMonZone = gTurnZonePtrs[2][i];
    ...
    for (j = 0; j < 5; j++) {
      struct DuelCard* opponentMonZone = gTurnZonePtrs[1][j];
...
u32 sub_8019CE4 (void) {
  u8 r5 = 5 - NumEmptyZonesInRow(gTurnZonePtrs[2]);
  u8 r4 = 5 - NumEmptyZonesInRow(gTurnZonePtrs[1]);
...
void TryAttackVoicing (void) {
  ...
  switch (sAI_Command.action) {
    ...
    case 13:
      ...
      attackVoicing.cardId = gTurnZonePtrs[row2][col2]->id;
...
static u8 sub_801A0B0 (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (gTurnZonePtrs[row2][col2]->id != CARD_NONE && !NumEmptyZonesInRow(gTurnZonePtrs[4])) {
    SetCardInfo(gTurnZonePtrs[row2][col2]->id);
    if (!gCardInfo.unk1E)
      return 1;
  }
...
static u8 sub_801A158 (void) {
  ...
  u8 col3 = sAI_Command.unk3 & 0xF;
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (gCardInfo.unk1E || ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) != 1
   || sub_8045390(gTurnZonePtrs[row2][col2]->id)
   || (gTurnZonePtrs[row3][col3]->id != CARD_NONE && IsCardLocked(gTurnZonePtrs[row3][col3])))
      return 0;
  return 1;
}
...
static u8 sub_801A250 (void) {
  ...
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (!gCardInfo.unk1E && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1
   && sub_8045390(gTurnZonePtrs[row2][col2]->id) == 1 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) == 1)
      return 1;
  return 0;
}
...
static u8 sub_801A338 (void) {
  ...
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (!gCardInfo.unk1E && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1
   && sub_8045390(gTurnZonePtrs[row2][col2]->id) == 2 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) == 1
   && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row4][col4]) == 1)
      return 1;
  return 0;
}
...
static u8 sub_801A488 (void) {
  ...
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (!gCardInfo.unk1E && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1
   && sub_8045390(gTurnZonePtrs[row2][col2]->id) == 3 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) == 1
   && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row4][col4]) == 1 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row5][col5]) == 1)
      return 1;
  return 0;
}
...
static u8 sub_801A630 (void) {
  ...
  if (gCardInfo.unk1E)
    return 0;
  if (ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1)
    r5 = 1;
  return r5;
}
...
static u8 sub_801A784 (void) {
  ...
  if (GetDuelistStatus(WhoseTurn()) && !gNotSure[0]->sorlTurns) {
    ...
    if (!gCardInfo.unk1E) {
      ...
      gTrapEffectData.unk3 = col2;
      gTrapEffectData.id = gTurnZonePtrs[row2][col2]->id;
      if (IsTrapTriggered() != 1 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1 &&
          !GetNumCardsInRow(1))
        return 1;
    }
  }
...
static u8 sub_801A8A4 (void) {
  ...
  if (GetDuelistStatus(WhoseTurn()) && !gNotSure[0]->sorlTurns) {
    ...
    if (!gCardInfo.unk1E) {
      ...
      gTrapEffectData.id = gTurnZonePtrs[row2][col2]->id;
      if (IsTrapTriggered() != 1 && ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row2][col2]) == 1 &&
          gTurnZonePtrs[row3][col3]->id != CARD_NONE && GetTypeGroup(gTurnZonePtrs[row3][col3]->id) == 1 &&
          gTurnZonePtrs[row3][col3]->isFaceUp)
        return 1;
    }
  }
  return 0;
...
static u8 sub_801B04C (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (sub_8043714(gTurnZonePtrs[row2][col2]) != 1)
    return 0;
  return 1;
}
...
static u8 sub_801B084 (void) {
  ...
  u8 col2 = sAI_Command.unk2 & 0xF;
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (!gCardInfo.unk1E && ZoneHasTrapCard(gTurnZonePtrs[row2][col2]) == 1 &&
      GetFINAL_Flag(gTurnZonePtrs[row2][col2]->id) < 1)
    return 1;
  return 0;
}
...
static u8 sub_801B0DC (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (ZoneHasTrapCard(gTurnZonePtrs[row2][col2]) != 1 || GetFINAL_Flag(gTurnZonePtrs[row2][col2]->id) < 1)
    return 0;
  return 1;
}
...
static u8 sub_801B178 (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (sub_804376C(gTurnZonePtrs[row2][col2]) != 1)
    return 0;
  return 1;
}
...
static u8 sub_801B2B8 (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (sub_8043790(gTurnZonePtrs[row2][col2]) == 1) {
    SetCardInfo(gTurnZonePtrs[row2][col2]->id);
    if (!gCardInfo.unk1E)
      return 1;
  }
...
static u8 sub_801B304 (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (GetTypeGroup(gTurnZonePtrs[row2][col2]->id) == 2 && GetSpellType(gTurnZonePtrs[row2][col2]->id) == 2) {
    SetCardInfo(gTurnZonePtrs[row2][col2]->id);
    if (gCardInfo.unk1E)
      return 1;
  }
...
static u8 sub_801B3FC (void) {
  u8 row2 = sAI_Command.unk2 >> 4;
  u8 col2 = sAI_Command.unk2 & 0xF;
  if (ZoneHasRitualCard(gTurnZonePtrs[row2][col2]) != 1)
    return 0;
  return 1;
}
...
static u8 sub_801B434 (void) {
  ...
  u8 col5 = sAI_Command.unk5 & 0xF;
  u8 zones[3];
  if (ZoneHasRitualCard(gTurnZonePtrs[row2][col2]) != 1 || ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row3][col3]) != 1 ||
      ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row4][col4]) != 1 || ZoneHasUnlockedMonsterCard(gTurnZonePtrs[row5][col5]) != 1)
    return 0;
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
...
static u8 sub_801B56C (void) {
  ...
  u8 col2 = sAI_Command.unk2 & 0xF;
  SetCardInfo(gTurnZonePtrs[row2][col2]->id);
  if (gCardInfo.unk1E && GetTypeGroup(gTurnZonePtrs[row2][col2]->id) == 2) // TYPE_GROUP_SPELL
    GetSpellType(gTurnZonePtrs[row2][col2]->id);
  return 0;
}

static u8 sub_801B5BC (u8 arg0, u16* arg1) {
  if (RowHasCardMatch(gTurnZonePtrs[2], *arg1) == 1 && GetFirstCardMatchZoneId(gTurnZonePtrs[2], *arg1) == arg0)
    return 1;
  return 0;
}
