...
_08055F86:
	...
	thumb_func_start sub_8055F8C
sub_8055F8C: @ 0x08055F8C
	movs r1, #0
	ldr r3, _08055FA4 @ =0x02024520
	movs r2, #0
_08055F92:
	adds r0, r1, r3
	strb r2, [r0]
	...
	bx lr
	.align 2, 0
_08055FA4: .4byte 0x02024520

	thumb_func_start sub_8055FA8
sub_8055FA8: @ 0x08055FA8
	push {r4, lr}
	adds r4, r0, #0
	lsls r4, r4, #0x10
	lsrs r0, r4, #0x10
...
_0805609C: .4byte 0x02024588
    ...
    thumb_func_start sub_80560A0
sub_80560A0: @ 0x080560A0
	push {r4, r5, r6, r7, lr}
	movs r6, #0
	ldr r5, _080560C0 @ =0x02024590
	ldr r4, _080560C4 @ =0x02024513
_080560A8:
	ldr r0, _080560C8 @ =0x02020DF8
	ldrh r0, [r0]
	cmp r0, #0x10
	beq _08056114
	cmp r0, #0x10
	...
	b _08056132
	.align 2, 0
_080560C0: .4byte 0x02024590
_080560C4: .4byte 0x02024513
_080560C8: .4byte 0x02020DF8
_080560CC:
	cmp r0, #0x40
	beq _080560E0
	cmp r0, #0x40
...
_08056108:
	...
	b _08056132
	.align 2, 0
_08056110: .4byte 0x02024590
_08056114:
	ldr r1, _08056124 @ =0x02024590
	ldrb r0, [r1]
	cmp r0, #7
	beq _08056132
_0805611C:
...
_08056132:
	...
	thumb_func_start sub_8056144
sub_8056144: @ 0x08056144
	ldr r2, _08056160 @ =0x02024510
	ldr r3, _08056164 @ =0x02024590
	ldrb r0, [r3]
	adds r2, #3
	adds r0, r0, r2
	movs r1, #0xff
	...
	bx lr
	.align 2, 0
_08056160: .4byte 0x02024510
_08056164: .4byte 0x02024590

	thumb_func_start sub_8056168
sub_8056168: @ 0x08056168
	ldr r2, _08056184 @ =0x02024510
	ldr r3, _08056188 @ =0x02024590
	ldrb r0, [r3]
	adds r2, #3
	adds r0, r0, r2
	movs r1, #0xa
	...
	bx lr
	.align 2, 0
_08056184: .4byte 0x02024510
_08056188: .4byte 0x02024590

	thumb_func_start sub_805618C
sub_805618C: @ 0x0805618C
	ldr r1, _0805619C @ =0x02024590
	ldrb r0, [r1]
	cmp r0, #0
	beq _08056198
	subs r0, #1
...
_08056198:
	bx lr
	.align 2, 0
_0805619C: .4byte 0x02024590

	thumb_func_start sub_80561A0
sub_80561A0: @ 0x080561A0
	ldr r1, _080561B0 @ =0x02024590
	ldrb r0, [r1]
	cmp r0, #7
	beq _080561AC
	adds r0, #1
